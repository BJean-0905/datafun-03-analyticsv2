...
Author: Denise Case,Britany Kine
Date: 2026-01
...
from datafun.bjean_csv_pipeline import run_app_mental_health
from datafun.bjean_json_pipeline import run_json_pipeline
from datafun.bjean_text_pipeline import run_text_pipeline
from datafun.bjean_xlsx_pipeline import run_xlsx_pipeline
...
def main() -> None:
    ...
    run_app_mental_health(raw_dir=RAW_DIR, processed_dir=PROCESSED_DIR, logger=LOG)
